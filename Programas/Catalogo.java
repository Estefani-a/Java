...
public class Catalogo  {
   ...
   * la posiciÃ³n que ocupa y, para cada disco, identifica
  ...
  public static boolean eliminaCelda(Object[] arreglo, int cual)  {
    ...
    for (int i = cual + 1; // empiezas uno despuÃ©s de la posicion dada
   ...
   * indicando lo que debe proporcionar y los lÃ­mites que
   * debe observar.
